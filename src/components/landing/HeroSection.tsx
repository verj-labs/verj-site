    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-6xl mx-auto px-6 text-center">
        <div className="mb-8">
          ...
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed font-lato">
            Welcome to <span className="font-semibold text-primary font-poppins">Verj Labs</span> — a digital innovation studio where bold ideas become real products.
            <br />
